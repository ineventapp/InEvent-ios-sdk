#import "INDirectoryAPIController.h"

@implementation INDirectoryAPIController
...
- (void)editAuthenticatedAtCompany:(NSInteger)companyID withKey:(NSString *)key withValue:(NSString *)value {
	...
	if (tokenID != nil && key != nil && value != nil) {
		...
		[self objectWithModule:@"directory" method:@"edit" attributes:attributes];
	}
}
...
- (void)getAuthenticatedAtCompany:(NSInteger)companyID {
	...
	if (tokenID != nil) {
		...
		[self objectWithModule:@"directory" method:@"get" attributes:attributes];
	}
}
