...
- (void)findAuthenticatedAtEventWithSelection:(NSString *)selection withQuery:(NSString *)query withQueryKey:(NSString *)queryKey withSort:(NSString *)sort withSortDirection:(NSString *)sortDirection withFilterStatus:(NSString *)filterStatus withFilterList:(NSString *)filterList withFilterTicket:(NSString *)filterTicket withPaginated:(NSString *)paginated withFilterCount:(NSString *)filterCount {
	...
	if (tokenID != nil && eventID != nil && selection != nil && query != nil && queryKey != nil && sort != nil && sortDirection != nil && filterStatus != nil && filterList != nil && filterTicket != nil && paginated != nil && filterCount != nil) {

		NSDictionary *attributes = @{@"GET" : @{@"tokenID" : tokenID, @"eventID" : eventID, @"selection" : selection, @"query" : query, @"queryKey" : queryKey, @"sort" : sort, @"sortDirection" : sortDirection, @"filterStatus" : filterStatus, @"filterList" : filterList, @"filterTicket" : filterTicket, @"paginated" : paginated, @"filterCount" : filterCount}};
