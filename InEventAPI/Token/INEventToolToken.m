...
#import "INEventToolToken.h"

@implementation INEventToolToken

#pragma mark - Singleton

+ (INEventToolToken *)sharedInstance
{
    static INEventToolToken *sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[INEventToolToken alloc] init];
    });
